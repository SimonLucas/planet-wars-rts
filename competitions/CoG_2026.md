# IEEE CoG 2026 Specifics

This competition will run in conjunction with the
[IEEE Conference on Games 2026](https://cog2026.org/).

---

## 🗓️ Submission Deadline

**August 30, 2026 — Anywhere on Earth**
...
The IEEE CoG 2026 competition will focus on the **fully observable**
...
from the ranges below (the same as for WCCI 2026):
...
The winner will be determined using the **average win rate over all games**
and/or the result of a **round robin between the leading distinct agents**.
The purpose of the leading-agent round robin is to identify the agent that
performs best against other strong agents, rather than relying only on
results accumulated against the full field.

These measures will usually identify the same winner. Strong agents in
Planet Wars typically beat weaker agents in nearly every game, although
the field does not always divide neatly into distinct strong and weak groups.
Where needed, the organisers will consider both measures when identifying
the best overall agent.

- The league will begin shortly after the deadline and be updated continuously.
...
**There is no prize money for the IEEE CoG 2026 competition.**

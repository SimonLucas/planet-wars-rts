# ==============================================================================
# FILE: agents/dqn_defense_agent_score_variant.py
# ==============================================================================
import os
import sys
import math
...
class DQN_Defense_Agent_Score_Variant(PlanetWarsPlayer):
    def __init__(self, model_path=None):
        ...
        if os.path.exists(self.model_path):
            try:
                ...
                print(f"✅ DQN_Defense_Agent_Score_Variant successfully loaded weights from {self.model_path}")
            except Exception as e:
                print(f"⚠️ Warning: Failed loading state_dict in DQN_Defense_Agent_Score_Variant ({e})")
        else:
            print(f"📡 DQN_Defense_Agent_Score_Variant checkpoint not found at {self.model_path}. Running default random layout.")

        # Cache the simulation opponent instance to avoid loading weights every game tick
        self.opp_agent = score_dqn_bot()
    ...
    def get_agent_type(self) -> str:
        return "DQN_Defense_Agent_Score_Variant (DQN Defense / score_dqn Sim Offense)"